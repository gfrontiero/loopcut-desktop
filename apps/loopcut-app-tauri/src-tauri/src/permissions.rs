...
fn check_accessibility_permission() -> OSPermissionStatus {
    core_to_os_status(loopcut_core::permissions::check_accessibility())
}
...
fn core_to_os_status(status: loopcut_core::permissions::PermissionStatus) -> OSPermissionStatus {
    match status {
        loopcut_core::permissions::PermissionStatus::NotNeeded => OSPermissionStatus::NotNeeded,
        loopcut_core::permissions::PermissionStatus::NotDetermined => OSPermissionStatus::Empty,
        loopcut_core::permissions::PermissionStatus::Granted => OSPermissionStatus::Granted,
        loopcut_core::permissions::PermissionStatus::Denied => OSPermissionStatus::Denied,
    }
}
...
pub fn check_microphone_permission() -> OSPermissionStatus {
    core_to_os_status(loopcut_core::permissions::check_microphone())
}
...
pub fn check_screen_recording_permission() -> OSPermissionStatus {
    core_to_os_status(loopcut_core::permissions::check_screen_recording())
}
