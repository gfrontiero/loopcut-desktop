              ...
              <div className="flex items-center space-x-2.5">
                ...
                <div>
                  <h3 className="text-sm font-medium text-foreground flex items-center gap-1.5">
                    ...
                    <HelpTooltip text="When enabled, the Loopcut overlay will be visible in screen recordings and screenshots made by other apps like OBS or Screen Studio." />
                  </h3>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-2.5">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">Overlay showing the Loopcut shortcut</p>
                </div>
              </div>
              <Switch
                id="shortcut-overlay"
