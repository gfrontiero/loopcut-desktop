...
use loopcut_db::CustomOcrConfig as DBCustomOcrConfig;
...
impl From<OcrEngine> for loopcut_db::OcrEngine {
    fn from(val: OcrEngine) -> Self {
        match val {
            OcrEngine::Unstructured => loopcut_db::OcrEngine::Unstructured,
            OcrEngine::Tesseract => loopcut_db::OcrEngine::Tesseract,
            OcrEngine::WindowsNative => loopcut_db::OcrEngine::WindowsNative,
            OcrEngine::AppleNative => loopcut_db::OcrEngine::AppleNative,
            OcrEngine::Custom(config) => {
                loopcut_db::OcrEngine::Custom(DBCustomOcrConfig::from(config))
            }
        }
    }
}

impl From<loopcut_db::OcrEngine> for OcrEngine {
    fn from(engine: loopcut_db::OcrEngine) -> Self {
        match engine {
            loopcut_db::OcrEngine::Unstructured => OcrEngine::Unstructured,
            loopcut_db::OcrEngine::Tesseract => OcrEngine::Tesseract,
            loopcut_db::OcrEngine::WindowsNative => OcrEngine::WindowsNative,
            loopcut_db::OcrEngine::AppleNative => OcrEngine::AppleNative,
            loopcut_db::OcrEngine::Custom(config) => OcrEngine::Custom(config.into()),
        }
    }
}
