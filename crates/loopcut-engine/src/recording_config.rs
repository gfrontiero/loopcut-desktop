...
use loopcut_audio::audio_manager::builder::TranscriptionMode;
use loopcut_audio::audio_manager::AudioManagerBuilder;
use loopcut_audio::core::engine::AudioTranscriptionEngine;
use loopcut_audio::transcription::VocabularyEntry;
use loopcut_audio::vad::VadEngineEnum;
use loopcut_config::{ChannelConfig, DbConfig};
...
pub struct RecordingConfig {
    ...
    pub schedule_rules: Vec<loopcut_config::ScheduleRule>,
...
impl RecordingConfig {
    ...
    pub fn from_settings(
        settings: &loopcut_config::RecordingSettings,
