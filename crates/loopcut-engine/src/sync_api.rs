...
pub async fn sync_init(
    ...
    let machine_id = request
        .machine_id
        .unwrap_or_else(loopcut_core::sync::get_or_create_machine_id);
    ...
    tokio::spawn(async move {
        use loopcut_core::sync::SyncEvent;
...
async fn download_pipe_manifest(
    manager: &Arc<loopcut_core::sync::SyncManager>,
) -> loopcut_core::pipes::sync::PipeSyncManifest {
    use loopcut_core::pipes::sync::PipeSyncManifest;
    use loopcut_core::sync::BlobType;
...
async fn upload_pipe_manifest(
    manager: &Arc<loopcut_core::sync::SyncManager>,
    manifest: &loopcut_core::pipes::sync::PipeSyncManifest,
) -> Vec<String> {
    use loopcut_core::sync::BlobType;
