...
use loopcut_screen::monitor::{get_monitor_by_id, list_monitors};
use loopcut_screen::PipelineMetrics;
...
impl VisionManager {
    ...
    pub fn is_monitor_allowed(&self, monitor: &loopcut_screen::monitor::SafeMonitor) -> bool {
    ...
    async fn start_event_driven_monitor(
        &self,
        monitor_id: u32,
        monitor: loopcut_screen::monitor::SafeMonitor,
    ) -> Result<JoinHandle<()>> {
