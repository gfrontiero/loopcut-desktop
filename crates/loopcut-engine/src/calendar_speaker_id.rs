...
pub fn start_speaker_identification(
    db: Arc<loopcut_db::DatabaseManager>,
...
async fn auto_name_input_speaker(db: Arc<loopcut_db::DatabaseManager>, user_name: &str) {
...
async fn run_speaker_identification_loop(
    ...
    let mut meeting_sub =
        loopcut_events::subscribe_to_event::<MeetingEventData>("meeting_started");
    let mut ended_sub = loopcut_events::subscribe_to_event::<MeetingEventData>("meeting_ended");
