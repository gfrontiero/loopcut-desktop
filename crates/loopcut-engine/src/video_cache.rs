...
use loopcut_db::{DatabaseManager, FrameData, OCREntry};
...
impl From<loopcut_db::AudioEntry> for AudioEntry {
    fn from(db_entry: loopcut_db::AudioEntry) -> Self {
        Self {
...
async fn extract_frame(
    ...
    let mut cmd = loopcut_core::ffmpeg_cmd_async(&ffmpeg);
    cmd.args([
        "-i",
        &video_file_path,
        "-vf",
