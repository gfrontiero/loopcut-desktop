...
use anyhow::Result;
use loopcut_a11y::{UiCaptureConfig, UiRecorder};
use loopcut_db::{DatabaseManager, InsertUiEvent};
                ...
                Some(event) => {
                    ...
                    if let Some(ref trigger_tx) = capture_trigger_tx {
                        ...
                        let trigger = match &db_event.event_type {
                            loopcut_db::UiEventType::AppSwitch => {
                            ...
                            loopcut_db::UiEventType::WindowFocus => {
                            ...
                            loopcut_db::UiEventType::Click => Some(CaptureTrigger::Click),
                            loopcut_db::UiEventType::Clipboard => {
