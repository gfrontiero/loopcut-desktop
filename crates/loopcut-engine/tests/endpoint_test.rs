...
mod tests {
    ...
    use loopcut_db::{ContentType, DatabaseManager, SearchResult};
    use loopcut_engine::SCServer;
    use loopcut_engine::{ContentItem, PaginatedResponse};
    use loopcut_screen::OcrEngine; // Adjust this import based on your actual module structure
    ...
    async fn test_search_audio_with_length_constraints() {
        ...
        let _ = db
            .insert_audio_transcription(
                ...
                0,
                "",
                &loopcut_db::AudioDevice {
                    name: "test1".to_string(),
                    device_type: loopcut_db::DeviceType::Input,
                },
                None,
                None,
                None,
