...
impl From<loopcut_db::DeviceType> for DeviceType {
    fn from(device_type: loopcut_db::DeviceType) -> Self {
        match device_type {
            loopcut_db::DeviceType::Input => DeviceType::Input,
            loopcut_db::DeviceType::Output => DeviceType::Output,
        }
    }
}

impl From<DeviceType> for loopcut_db::DeviceType {
    fn from(device_type: DeviceType) -> Self {
        match device_type {
            DeviceType::Input => loopcut_db::DeviceType::Input,
            DeviceType::Output => loopcut_db::DeviceType::Output,
        }
    }
}

impl From<DeviceType> for Arc<loopcut_db::DeviceType> {
    fn from(device_type: DeviceType) -> Self {
...
impl From<loopcut_db::AudioDevice> for AudioDevice {
    fn from(device: loopcut_db::AudioDevice) -> Self {
        AudioDevice {
            name: device.name,
