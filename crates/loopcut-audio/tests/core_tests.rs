...
mod tests {
    ...
    use loopcut_audio::core::record_and_transcribe;
    use loopcut_audio::core::stream::AudioStream;
    use loopcut_audio::speaker::embedding::EmbeddingExtractor;
    use loopcut_audio::speaker::embedding_manager::EmbeddingManager;
    use loopcut_audio::speaker::prepare_segments;
    use loopcut_audio::vad::{silero::SileroVad, VadEngine};
    use loopcut_audio::{pcm_decode, AudioInput, TranscriptionEngine};
    use loopcut_core::Language;
    ...
    async fn test_record_and_transcribe() {
        ...
        let result = record_and_transcribe(
            ...
            Arc::new(sender),
            is_running,
            Arc::new(loopcut_audio::metrics::AudioPipelineMetrics::new()),
        )
        .await;
    ...
    async fn test_audio_transcription_language() {
        ...
        let audio_data = loopcut_audio::pcm_decode("test_data/Arifi.wav")
