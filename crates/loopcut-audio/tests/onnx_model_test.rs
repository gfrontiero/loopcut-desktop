...
mod tests {
    ...
    use loopcut_audio::speaker::models::{get_or_download_model, PyannoteModel};
    use loopcut_audio::vad::silero::SileroVad;
    use loopcut_audio::vad::VadEngine;
    ...
    async fn test_onnx_segmentation_model_loads() -> Result<()> {
        ...
        let start = Instant::now();
        let session = loopcut_audio::speaker::create_session(&segmentation_model_path)?;
    ...
    async fn test_onnx_startup_sequence() -> Result<()> {
        ...
        let _segmentation_session = loopcut_audio::speaker::create_session(&segmentation_path)?;
